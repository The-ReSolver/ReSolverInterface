...
find_field(a::AbstractVectorField, rest) = a
# find_field(a::Base.Broadcast.Extruded{<:AbstractVectorField}, rest) = a.x
...
@inline unpack(x::AbstractVectorField,    i) = x.elements[i]
