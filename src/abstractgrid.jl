...
"""
getβ(::AbstractGrid) = error("Missing concrete method for getβ")
...
"""
getω(::AbstractGrid) = error("Missing concrete method for getω")
...
"""
getDy(::AbstractGrid) = error("Missing concrete method for getDy")
...
"""
getDy2(::AbstractGrid) = error("Missing concrete method for getDy2")
